	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (ConfigureData.isUsingFBLoginButton
			...
			try {
				...
				edtUserName.setText(ConfigureData.graphUser.getUsername());
				edtPassWord.setText(ConfigureData.graphUser.getId());
				edtConfirmPass.setText(ConfigureData.graphUser.getId());
				edtAddress.setText(ConfigureData.graphUser.getLocation()
						.getStreet()
						+ ConfigureData.graphUser.getLocation().getCity());
