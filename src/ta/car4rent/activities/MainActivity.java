	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mNavigationDrawerListItems.add(new NavigationDrawerListItem(
				NavigationDrawerListItem.CATEGORY_NAME, 0, this
						.getString(R.string.label_application_session), "",
				null));
		...
		mNavigationDrawerListItems.add(new NavigationDrawerListItem(
				...
				R.drawable.ic_nd_newsfeed, this
						.getString(R.string.label_post_newsfeed), "",
				new OnNavigationDrawerItemClickHandler() {
		...
		mNavigationDrawerListItems.add(new NavigationDrawerListItem(
				NavigationDrawerListItem.CATEGORY_NAME, 0, this
						.getString(R.string.label_4cars), "", null));
		...
		mNavigationDrawerListItems.add(new NavigationDrawerListItem(
				NavigationDrawerListItem.SCREEN_IN_CATEGORY,
				R.drawable.ic_nd_introduce, this
						.getString(R.string.label_introduce), "",
				new OnNavigationDrawerItemClickHandler() {
